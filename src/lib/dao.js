...
class DAO {
     ...
     */
    static findByFields({fields, limit, order, page, pageCount}) {
        ...
        if (page != null && !isNaN(page)) {
            ...
            var page = page;
            var pageCount = pageCount != null ? pageCount : pageCountLimit;
            
            pageCount = pageCount > pageCountLimit ? pageCountLimit : pageCount;
            var offset = (page - 1) * pageCount;

            baseQuery += "LIMIT ?"
            params.push([offset, pageCount])
        }
