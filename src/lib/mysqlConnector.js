...
class MySQLConnector {
    ...
    get MYSQL_DB_USER() { return process.env.MYSQL_DB_NAME || 'graphql_prac' }
    get MYSQL_DB_NAME() { return process.env.MYSQL_DB_NAME || 'graphql_prac' }
    get MYSQL_DB_PASSWORD() { return process.env.MYSQL_DB_PASSWORD || 'graphql_prac' }
